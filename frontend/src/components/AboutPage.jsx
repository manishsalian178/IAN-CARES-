            ...
            <section className="py-20 bg-white/60 backdrop-blur-sm px-6">
                <div className="max-w-[1200px] mx-auto text-center">
                    ...
                    <p className="text-xl text-slate-600 leading-relaxed max-w-4xl mx-auto">
                        Born out of love and loss, Ian Cares Foundation was established in memory of <br /> Ian Austin Mascarenhas — a young soul who inspired compassion and care. After his tragic passing in 2017, his family turned grief into a mission to fight the “3 Ds” — Drinks, Drugs, and Depression — helping others find strength and purpose again.
                    </p>
                </div>
            </section>
